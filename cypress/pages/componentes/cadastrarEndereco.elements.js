export const CADASTRO = {
    BTN_EDIT      : 'a.app__button',
    INP_ADRESS   : '[id="address-description"]',
    INP_CEP       : 'input#address-cep',
    INP_RUA       : 'input#address-street',
    INP_RUA_NUM   : 'input#address-number',
    INP_COMPLEMENT: 'input#address-complement',
